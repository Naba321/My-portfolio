  ...
  const projects = [
    {
      ...
      technologies: ['html', 'css', 'javascript'] as const,
    ...
    },
    {
      ...
      link: "https://github.com/Naba321/Electricity-Bill-Management-System",
    },
    {
      ...
      technologies: ['SDN', 'Mininet', 'Python'] as const,
    ...
    },
    {
      ...
      technologies: ['Wazuh', 'Shuffle', 'VirusTotal API'] as const,
